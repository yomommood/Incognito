...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/yomommood/Incognito/tree/main)
...
```sh
git clone https://github.com/yomommood/Incognito
cd Incognito
npm install
npm start
```
